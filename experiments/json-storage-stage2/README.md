...
阶段二已完成 6 个正式 run、18 个布局结果。结论见[阶段二横向报告](../../docs/json-storage/json-storage-stage2-report-2026-09-10.md)。正式统计仅使用 `formal-20260907-retry-3/`；`formal-20260907/`、`formal-20260907-retry-1/`、`formal-20260907-retry-2/` 的全部产物只用于诊断。
